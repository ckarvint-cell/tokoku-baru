...
alter table public.orders add column if not exists nama_kurir text;
alter table public.orders add column if not exists kurir text;
...
alter table public.orders
  ...
  check (status in ('Menunggu Ongkir', 'Menunggu Pembayaran', 'Menunggu Konfirmasi', 'Proses', 'Diproses', 'Pesanan Dikirim', 'Ditolak', 'menunggu_ongkir', 'menunggu_pembayaran', 'menunggu_konfirmasi', 'proses', 'diproses', 'pesanan_dikirim', 'ditolak'));
