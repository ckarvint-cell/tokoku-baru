...
export default function SettingsPage() {
  ...
  async function sendPasswordResetEmail() {
    ...
    setPasswordMessage("Link reset password sudah dikirim ke email akun ini. Silakan cek inbox atau spam.");
  }
    ...
    <main className="min-h-screen bg-[#fbf7f4] px-5 py-10 text-slate-950">
      <div className="mx-auto max-w-3xl">
        ...
        <section className="mt-5 rounded-lg border border-rose-100 bg-white p-6 shadow-sm">
          ...
          {passwordMessage && (
            <p className={`mt-4 rounded-md px-3 py-2 text-sm ${passwordSuccess ? "bg-emerald-50 text-emerald-700" : "bg-rose-50 text-rose-700"}`}>
              {passwordMessage}
            </p>
          )}
